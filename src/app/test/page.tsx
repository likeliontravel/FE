...
import Subscription_modal from '../mypage/_component/Subscription_modal';

export default function Modify() {
  const [selectedTab, setSelectedTab] = useState<
    'info' | 'subscription' | 'group'
  >('info');
  ...
  return (
    <>
          ...
          <div className={style.mypage_div}>
            ...
            <div className={style.mypage_content}>
                    ...
                    <div className={style.subscription}>
                      <div>
                        <div className={style.subscription_left}>
                          ...
                          <p className={style.next_plan}>
                            다음 결제일 : 2025/3/2
                          </p>
                        </div>
                        <div
                          className={style.subscription_right}
              ...
              {selectedTab === 'subscription' && (
                <>
                  <h3>구독 결제 내역</h3>
                  <div className={style.subscription_history}></div>
                </>
              )}
              ...
              {selectedTab === 'group' && (
                <>
                  <h3>그룹 및 일정</h3>
                  <div className={style.group_schedule}></div>
                </>
              )}
            </div>
          </div>
      ...
      {subscription && (
        <Subscription_modal onClose={() => setSubscription(false)} />
      )}
    </>
  );
}
